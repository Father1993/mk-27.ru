...
else
{
	...
	<h1 class="order-h1"><?$APPLICATION->ShowTitle(false);?></h1>
		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="col-sm-12 bx-soa">
				...
				<? if ($arParams['BASKET_POSITION'] === 'before'): ?>
					...
					<div class="selector">
						<i class="fa fa-angle-down"></i>Подробнее о составе заказа
					</div>
					
					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active bx-soa-basket">
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
				...
				<!--	REGION BLOCK	-->
				<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active col-md-6 region-block">
				...
				<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
					<!--	PAY SYSTEMS BLOCK	-->
					<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active col-md-4">
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
					...
					<!--	DELIVERY BLOCK	-->
					<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active col-12" <?=($hideDelivery ? 'style="display:none"' : '')?>>
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
				...
				<? else: ?>
					<!--	DELIVERY BLOCK	-->
					<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active col-md-6" <?=($hideDelivery ? 'style="display:none"' : '')?>>
						<div class="block-title">Способы доставки</div>
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
								<span class="bx-soa-section-title-count"></span><?=$arParams['MESS_DELIVERY_BLOCK_NAME']?>
							</h2>
					...
					<!--	PAY SYSTEMS BLOCK	-->
					<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active col-md-6">
				...
				<div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active">
					<div class="block-title-address">Контактные данные</div>
					<div class="bx-soa-section-title-container">
						<h2 class="bx-soa-section-title col-sm-9">
    			...
    			<div class="col-md-4"></div>
    			<div id="bx-soa-total" class="col-md-4 bx-soa-sidebar">
    				<div class="bx-soa-cart-total-ghost"></div>
    				<div class="bx-soa-cart-total"></div>
    				
    				<div class="delivery-text">
    					Стоимость доставки рассчитывается менеджером после оформления заказа.
    				</div>
