...
$(function(){
	$(".selector").click(function(){
		if ($(".bx-soa-basket").css("display") === "none")
		{
			$(".bx-soa-basket").slideDown();
			$(".selector i").css("transform", "rotate(180deg)");
		}
		else 
		{
			$(".bx-soa-basket").slideUp();
			$(".selector i").css("transform", "rotate(0deg)");
		}
	});
});
