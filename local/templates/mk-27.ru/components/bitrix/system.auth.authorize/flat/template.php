...
<?if ($arParams["NOT_SHOW_LINKS"] != "Y"):?>
	...
	<p class="">Если вы ранее уже совершали заказ, то для вас аккаунт уже создан. Чтобы получить к нему доступ восстановите пароль по ссылке "Забыли свой пароль":</p>
