			...
			<div class="row <?=$rowData['CLASS']?>" data-entity="items-row">
				...
				switch ($rowData['VARIANT'])
				{
					...
					case 2:
						...
						// Наш вариант
						/*
						// Если страница поиска или избранное
						if ($arParams["IS_SEARCH"] == "Y" || $arParams["IS_FAVORITE"] == "Y")
						{
						    $cols = "col-lg-4";
						}
						else
						...
						*/
						...
						<div class="col-xs-12 product-item-small-card">
							<div class="row">
								...
								{
									?>
									<div class="col-6 col-sm-4 col-md-4 col-xl-3 product-item-big-card">
										<div class="row">
											<div class="col-md-12">
												<?
												$APPLICATION->IncludeComponent(
...
{
	?>
	<div class="row lazy-load-block bx-<?=$arParams['TEMPLATE_THEME']?>">
		<div class="col-12">
    		<div class="btn btn-default btn-lg center-block pagenavigation" style="margin: 15px;"
