      ...
      <div class="col-lg-8">
        <div class="company-intro">
          ...
          <ul class="features-list">
            ...
            <li>Электрический и ручной инструмент</li>
            <li>Комплектующие для опалубки</li>
            <li>Металлические сетки</li>
          </ul>
        </div>
      </div>
      <div class="col-lg-4">
    ...
    <div class="logistics-section">
      ...
      <div class="logistics-content">
        <p>Компания «Метиз Комплект» осуществляет доставку товаров на всей территории Дальнего Востока и в центральную
          часть страны. За 15 лет работы создан собственный автопарк транспорта грузоподъёмностью от 3 до 25 тонн.</p>
