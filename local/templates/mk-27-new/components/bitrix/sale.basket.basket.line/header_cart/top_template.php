...
<a href="<?=$arParams['PATH_TO_BASKET']?>">
		...
		<div class="cart-cont"><?=$arResult['NUM_PRODUCTS']?></div>
	
    <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/ic-cart.svg">
    <span>
        <?php if ($arResult["TOTAL_PRICE_RAW"] > 0):?>
        	<?=number_format($arResult["TOTAL_PRICE_RAW"], 2, '.', ' ');?>&nbsp;₽
    	<?php else: ?>
    	<?php /* ?>
    		<span>
