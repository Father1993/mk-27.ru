...
<div class="gallery container">
	...
	<div class="row">
		...
		<h1>Фотогалерея<? if ($arResult["SECTION"]["NAME"]) echo ": " . $arResult["SECTION"]["NAME"];?></h1>
		
		<?php if ($arResult["SECTION"]["DEPTH_LEVEL"] == 1): ?>
			<a href="/gallery/" class="return"><span>➜</span> Назад</a>
        <?php endif; ?> 
        	...
        	<div class="col-12 col-md-6 col-lg-4 col-xl-3 item" id="<?=$this->GetEditAreaId($item['ID']);?>">
            	<a href="<?=$section["SECTION_PAGE_URL"]?>">
                	<div class="item-inner">
            			<div class="picture" style="background-image: url('<?=$section["PICTURE"]["SRC"]?>');"></div>
