...
<?php if ($arResult["ITEMS"]): ?>
    ...
    <div class="catalog-products-viewed-head">Вы недавно смотрели</div>
    
    <div class="catalog-products-viewed owl-carousel">
    	...
    	<?php endif; ?>
        	...
        	<div class="product-price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
            	...
            	<span>
                	<?php if ($arItem["ITEM_PRICES"][0]["PRICE"] > 0): ?>
                		<?=number_format($arItem["ITEM_PRICES"][0]["PRICE"], 2, '.', ' ');?><i class="fa fa-rub" aria-hidden="true"></i>
                		<span itemprop="price" style="display: none;"><?=number_format($arItem["ITEM_PRICES"][0]["PRICE"], 2, '.', ' ');?></span>
            		<?php else: ?>
            			Под заказ
        			<?php endif; ?>
        		</span>
