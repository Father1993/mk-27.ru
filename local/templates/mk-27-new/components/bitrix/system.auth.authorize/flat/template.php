...
?>
  ...
  <form name="form_auth" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
    ...
    <div class="bx-authform-formgroup-container">
      <div class="bx-authform-label-container">E-Mail (Логин)</div>
    ...
    <div class="bx-authform-formgroup-container dbg_captha">
      ...
      <div class="bx-captcha"><img src="/bitrix/tools/captcha.php?captcha_sid=<?echo $arResult[" CAPTCHA_CODE"]?>"
  ...
  <p class="">Если вы ранее уже совершали заказ, то для вас аккаунт уже создан. Чтобы получить к нему доступ
    восстановите пароль по ссылке "Забыли свой пароль":</p>
  ...
  <noindex>
    <div class="bx-authform-link-container">
      ...
      <a href="/personal_section/registration.php" rel="nofollow"><b><?=GetMessage("AUTH_REGISTER")?></b></a>
    </div>
  </noindex>
  <?endif?>
