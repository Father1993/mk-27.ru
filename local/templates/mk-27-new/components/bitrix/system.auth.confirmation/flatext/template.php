...
<div class="bx-authform-block">
  <div>Вы успешно зарегистрировались и авторизовались. Теперь вы можете:</div>
  <div class="bx-block"><a href="/" class="sale-order-history-link">Перейти в каталог</a></div>
  <div class="bx-block"><a href="/personal_section/" class="sale-order-history-link">Перейти в личный кабинет</a></div>
</div>
<? } else {
?>
  ...
  <form method="post" action="<?echo $arResult[" FORM_ACTION"]?>">
    <div class="bx-authform-formgroup-container">
      ...
      <div class="bx-authform-input-container">
        <input type="text" name="<?echo $arParams[" LOGIN"]?>" maxlength="50" value="
        <?echo $arResult["LOGIN"]?>" />
      </div>
    </div>
    ...
    <div class="bx-authform-formgroup-container">
      ...
      <div class="bx-authform-input-container">
        <input type="text" name="<?echo $arParams[" CONFIRM_CODE"]?>" maxlength="50" value="
        <?echo $arResult["CONFIRM_CODE"]?>" />
      </div>
    </div>
    ...
    <input type="hidden" name="<?echo $arParams[" USER_ID"]?>" value="
