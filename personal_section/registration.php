  ...
  <ul class="nav-tabs">
    <li>
      <a class="nav-link <? if($_GET[" type"]=="personal" || !isset($_GET["type"])) { ?>active
        <? } ?>"
        href="/personal_section/registration.php?type=personal">Физическое лицо
      </a>
    </li>
    <li>
      <a class="nav-link <? if($_GET[" type"]=="legal" ) { ?>active
        <? } ?>"
        href="/personal_section/registration.php?type=legal">Юридическое Лицо
      </a>
    </li>
  </ul>
    ...
    <div class="faq-tab-pane">
      <?$APPLICATION->IncludeComponent("bitrix:main.register",
                        ...
                        Array(
                            ...
                            "AUTH" => "Y",
                            "USE_BACKURL" => "Y",
                            "SUCCESS_PAGE" => "/personal_section/success/",
                            "SET_TITLE" => "Y",
                            "USER_PROPERTY" => Array(),
                            "SEF_FOLDER" => "/",
